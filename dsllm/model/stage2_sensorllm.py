...
class SensorLLMStage2LlamaModel(BaseSensorLLMModel):
    ...
    def forward(
        ...
        # Filter kwargs based on what the parent's forward method accepts
        base_forward = super(SensorLLMStage2LlamaModel, self).forward
        ...
        filtered_kwargs = {
            ...
            }.items() if k in base_forward_params
        }
