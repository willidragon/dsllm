...
class SensorLLMTrainer(Trainer):
    ...
    def save_model(self, output_dir: Optional[str] = None, _internal_call: bool = False):
        if hasattr(self, "fsdp") and self.fsdp is not None:
...
class SensorLLMWeightedCELossTrainer(SensorLLMTrainer):
    def __init__(self, *args, class_weights=None, **kwargs):
        ...
        print(f"Original class_weights shape: {class_weights.shape}")
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        print(f"Using weights shape: {weights.shape}, logits shape: {logits.shape}, labels shape: {labels.shape}")
