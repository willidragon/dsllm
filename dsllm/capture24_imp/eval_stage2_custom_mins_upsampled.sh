...
MODEL_DIR="/project/cc-20250120231604/ssd/users/kwsu/data/trained_model/SensorLLM_train_stage2/capture24_stage2_300seconds_100DS_with_val"
DATA_TAG="300seconds_100DS_upsampled_from_1000DS"
OUTPUT_FILE_NAME="eval_capture24_${DATA_TAG}.json"

# Use the upsampled data directory for 100DS_upsampled_from_1000DS
DATA_DIR="/project/cc-20250120231604/ssd/users/kwsu/research/dsllm/dsllm/data/stage_2_upsampled/${DATA_TAG}/test"
DATA_PATH="$DATA_DIR/capture24_test_data_stage2_300seconds_100DS_upsampled.pkl"
